...
if __name__ == '__main__':
    ...
    parser.add_argument("--local_embedding_path", default="cluster_codebook_1000cls_100000.pth", type=str, help="path of llama model")
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for i, [image_ids, images, label_cls] in enumerate(metric_logger.log_every(data_loader_train, print_freq, header)):
