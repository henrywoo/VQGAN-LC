...
│   │   │   │   │       └── 💠 Conv2d(conv1,conv2)<🦜:590080x2>|weight[256,256,3,3]|bias[256]
│   │   │   │   └── Downsample(downsample)
...
│   │   │   │   └── 💠 Conv2d(12-12,14-14)<🦜:0,590080x2>|weight[256,256,3,3]❄️|bias[256]❄️
│   │   │   ├── Sequential(slice4)
│   │   │   │   ├── Conv2d(17)|weight[512,256,3,3]❄️|bias[512]❄️
│   │   │   │   └── 💠 Conv2d(19-19,21-21)<🦜:0,2359808x2>|weight[512,512,3,3]❄️|bias[512]❄️
│   │   │   └── Sequential(slice5)
│   │   │       └── 💠 Conv2d(24-24,26-26,28-28)<🦜:0,2359808x3>|weight[512,512,3,3]❄️|bias[512]❄️
│   │   ├── NetLinLayer(lin0)
│   │   │   └── Sequential(model)
...
└── GPT(transformer)|pos_emb[1,257,1024]
    ├── 💠 Embedding(tok_emb),💠 Linear(head)<🦜:103424000x2>|weight[101000,1024]
    ├── Sequential(blocks)
    │   └── 💠 Block(0-23)<🦜:12596224x24>
    │       ┣━━ 💠 LayerNorm(ln1,ln2)<🦜:2048x2>|weight[1024]|bias[1024]
